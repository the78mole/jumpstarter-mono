...
import (
	...
	"github.com/the78mole/jumpstarter-mono/core/controller/internal/service"
...
func main() {
	...
	if printVersion {
		fmt.Printf("Jumpstarter Controller\n")
	...
	setupLog.Info("starting manager", "version", Version, "commit", Commit, "buildTime", BuildTime)
